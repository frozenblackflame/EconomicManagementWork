...
if __name__ == "__main__":
    departments=[
        ...
        "肝胆胰肿瘤外科", "消毒供应中心", "头颈二科", "皮肤科",
        "泌尿外科", "多学科联合(MDT)门诊", "病理科", "妇瘤一科", "便民门诊",
        "财务部", "结直肠肿瘤外科", "名老中医工作室", "功能科", "妇瘤二科",
        "针灸理疗室", "医务部", "乳腺内科", "特需门诊", "核医学科",
        "骨与软组织一科", "重症医学科", "放射治疗科", "检验科", "骨与软组织二科",
        "麻醉手术科", "中西医结合科", "放射科", "乳腺一科", "麻醉手术科护士",
        "血液病科", "门诊收费室", "乳腺二科", "放疗机房", "消化肿瘤内一科",
        "住院收费室", "胸外一科", "药学部", "消化肿瘤内二科", "门诊部",
